...
public class BoardAdjTargetTest {
	...
	public void testAdjacenciesRooms()
	{
		...
		assertTrue(testList.contains(board.getCell(2, 22))); // This cell is a secret passage
	...
	// These are Dark Gray on the planning spreadsheet
	@Test
	...
	// Test out of room center, 1, 2, 3
	// These are Pink on the planning spreadsheet
	@Test
	public void testTargetsInChurch() {
		// test a roll of 1
		board.calcTargets(board.getCell(20, 3), 1);
		Set<BoardCell> targets= board.getTargets();
		...
		// test a roll of 2
		board.calcTargets(board.getCell(20, 3), 2);
		targets= board.getTargets();
		...
		// test a roll of 3
		board.calcTargets(board.getCell(20, 3), 3);
		targets= board.getTargets();
	...
	// Test walkway has targets 1
	// These are Gray in the planning spreadsheet
	@Test
	...
	// Light Green in the spreadsheet
	@Test
