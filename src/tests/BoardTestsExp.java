...
public class BoardTestsExp {
   ...
   // @Test
    public void testTargetsRoom() {
        ...
        board.calcTargets(cell, 2); // move 2
        Set<TestBoardCell> targets = board.getTargets();
        Assert.assertEquals(3, targets.size());
        // check positions
        Assert.assertTrue(targets.contains(board.getCell(2, 2))); 
    ...
    public void testTargetsRoll6() {
        ...
        Set<TestBoardCell> targets = board.getTargets();
        Assert.assertTrue(targets.contains(board.getCell(0, 2))); // up 2, left 4
        Assert.assertTrue(targets.contains(board.getCell(4, 2))); // down 2, right 4
        Assert.assertTrue(targets.contains(board.getCell(2, 4))); // right 6
        Assert.assertTrue(targets.contains(board.getCell(2, 0))); // left 6
        Assert.assertTrue(targets.contains(board.getCell(3, 3))); // down 1, right 5
        Assert.assertTrue(targets.contains(board.getCell(3, 1))); // down 1, left 5
        Assert.assertTrue(targets.contains(board.getCell(1, 3))); // up 1, right 5
        Assert.assertTrue(targets.contains(board.getCell(1, 1))); // up 1, left 5
        Assert.assertEquals(8, targets.size()); // 8 possible positions
    }
    ...
    public void testTargetsRoll3() {
        ...
        Assert.assertTrue(targets.contains(board.getCell(0, 2))); // Up 1, Right 2
        Assert.assertTrue(targets.contains(board.getCell(2, 2))); // Down 1, Right 2
        Assert.assertTrue(targets.contains(board.getCell(3, 1))); // Down 2, Right 1
        Assert.assertTrue(targets.contains(board.getCell(1, 0))); // Left 1, Down 2
        Assert.assertTrue(targets.contains(board.getCell(0, 1))); // Up 1, Left 2
        Assert.assertTrue(targets.contains(board.getCell(1, 3))); // Right 3
    }
